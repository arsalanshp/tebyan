...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.CustomViewHolder> {
    ...
    public FolderAdapter(FragmentActivity context, GetFileModel_ data, boolean changeView,int type) {
        super();
        activity = context;
        this.data = data;
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == 0) {
            ...
            view = LayoutInflater.from(viewGroup.getContext()).inflate(changeView ? R.layout.list_row_layout : R.layout.list_row, viewGroup, false);
        } else if (viewType == 2) {
